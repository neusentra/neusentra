...
import { useEffect, useState, useRef, type SVGAttributes, type HTMLAttributes, type ReactNode, forwardRef, useCallback } from 'react';
...
export const Navbar = forwardRef<HTMLElement, NavbarProps>(
  (
    {
      className,
      logo = <Logo width='1.5em' height='1.5em' className='fill-black dark:fill-white' />,
    ...
    return (
      <header
        ...
        {...props}
      >
        <div className="container mx-auto flex h-16 max-w-screen-2xl 2xl:max-w-screen items-center justify-between gap-4">
          {/* Left side */}
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                {/* <span className="hidden font-asgrike font-medium text-2xl sm:inline-block">NeuSentra</span> */}
              </button>
              {/* Navigation menu */}
              {!isMobile && (
